...
""" if is_ar else """
<style>
  html, body, [data-testid="stAppViewContainer"] * { direction: LTR; text-align: left; }
</style>
"""
...
def call_backend(user: str, text: str) -> str:
...
if user_text:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking…"):
            reply = call_backend(username.strip(), user_text.strip())
            st.markdown(reply)
